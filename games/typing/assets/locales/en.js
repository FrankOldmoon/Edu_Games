...
export default {
  ui: {
    ...
    raceLead: "Everyone types the same code. Clear a level and you go straight on to the next — nobody waits for anybody. First to finish all <b>{levels}</b> levels wins, starting at level {level}.",
    countdownHint: "Get ready — the code unlocks for everyone at the same moment.",
    racingHint: "Level {level}/{levels} · {chars} characters",
    levelCleared: "Cleared — next level coming up",
    doneHint: "Race over. The results are up.",
    waitingOthers: "All levels done — waiting for the others",
    finishLine: "finish",
    playerNo: "Player {n}",
    you: "(you)",
    raceWon: "You won!",
    raceOver: "Race over",
    racePlace: "You came #{place} of {total}",
    raceDnf: "You did not get to the end",
    raceTime: "All {levels} levels · finished in {time}",
    coursePartial: "Reached level {done} of {levels}",
