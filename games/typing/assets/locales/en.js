...
export default {
  ui: {
    ...
    raceLead: "Everyone types the same code — first to the top wins. <b>{chars}</b> characters.",
    countdownHint: "Get ready — the code unlocks for everyone at the same moment.",
    racingHint: "{chars} characters — go!",
    doneHint: "Race over. The standings are on the right.",
    waitingOthers: "Finished — waiting for the others",
    finishLine: "finish",
    playerNo: "Player {n}",
    you: "(you)",
    raceWon: "You won!",
    ...
    raceDnf: "You did not finish this one",
