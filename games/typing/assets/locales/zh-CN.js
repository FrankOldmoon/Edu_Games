...
export default {
  ui: {
    ...
    endRace: "结束比赛",
    raceAgain: "再来一场",
    raceLead: "大家打同一段代码。过一关就直接进下一关，不用等任何人；先打完这 <b>{levels}</b> 关的赢。从第 {level} 关开始打。",
    countdownHint: "准备好 —— 代码对所有人在同一时刻解锁。",
    racingHint: "第 {level}/{levels} 关 · {chars} 个字符",
    levelCleared: "过关 —— 下一关马上来",
    doneHint: "比赛结束，看看结果。",
    waitingOthers: "全部打完了 —— 等其他人",
    finishLine: "终点",
    playerNo: "玩家 {n}",
    you: "（你）",
    raceWon: "你赢了！",
    ...
    raceDnf: "这一场没跑到最后",
    raceTime: "全部 {levels} 关 · 用时 {time}",
    coursePartial: "打到第 {done}/{levels} 关",
